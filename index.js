...
let previousRollButtonClickCount = 0;

diceRoller.addEventListener("click", function () {
    previousRollButtonClickCount = rollButtonClickCount;
    rollButtonClickCount++;
    
    if (rollButtonClickCount === previousRollButtonClickCount + 1) {
